...
=======
        { id: 1, title: "Music Production 101", instructor: "John Doe" },
        { id: 2, title: "Band Management Strategies", instructor: "Jane Smith" },
        { id: 3, title: "Guitar Mastery Workshop", instructor: "Alex Johnson" },
        { id: 4, title: "Songwriting Fundamentals", instructor: "Emily Davis" },
        { id: 5, title: "Live Performance Techniques", instructor: "Chris Rodriguez" },
        { id: 6, title: "Electronic Music Production", instructor: "Mia Williams" },
    ...
    courses.forEach(course => {
        ...
        `;
        courseElement.querySelector(".enroll-button").addEventListener("click", handleEnroll);
    ...
    function displayModulesInLecture(modules) {
        ...
        lectureContent.innerHTML = `
            <h3>Modules for ${document.getElementById("courseId").value}</h3>
            <p>Video: <a href="${modules.video}" target="_blank">Watch Video</a> <button onclick="downloadFile('${modules.video}')">Download</button></p>
            <p>PDF: <a href="${modules.pdf}" target="_blank">View PDF</a> <button onclick="downloadFile('${modules.pdf}')">Download</button></p>
            <p>Homework Assignment: <a href="${modules.homework}" target="_blank">Download Assignment</a> <button onclick="downloadFile('${modules.homework}')">Download</button></p>
        `;
    }
    
    function downloadFile(fileUrl) {
        // You can customize this function based on how you want to handle file downloads.
        // For simplicity, it opens the file URL in a new tab.
